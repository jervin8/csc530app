...
//define onclick functions for different aspects of the navbar
//the dropdown will be for account details and login/logout

    return (
        <nav className="bg-white border-gray-200 dark:bg-gray-900 dark:border-gray-700 w-full shadow">
